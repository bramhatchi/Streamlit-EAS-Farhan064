...
def ad():
 ...
 column=st.sidebar.selectbox('Pilih kolom disini, yuk!',['COUNTRY','PRODUCTLINE','CITY'])
 type_of_column=st.sidebar.radio("Jenis analisis apa yang kamu inginkan, nih?",['Categorical','Numerical'])
